	...
	class Contacts extends View {
		...
		public function Render(): void { ?>
			<div class = "view general contacts">
				<p><?= Params::$site_name; ?> – это молодой, развивающийся проект, который нуждается в Вашей <?= General::instance()->donations->GetLink('доброй поддержке', [], ['class' => 'link']); ?>, здоровой критики и пожеланиях по дальнейшему улучшению.</p>
